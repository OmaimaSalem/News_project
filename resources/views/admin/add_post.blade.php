...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
         <h1>{{__('admin.addpost')}}</h1>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="#"> {{__('admin.home')}}
</a></li>
            <li class="breadcrumb-item active"> {{__('admin.addpost')}}
</li>
          </ol>
        </div>
      </div>
          ...
          <form method="POST" action="{{route('posts.store')}}" enctype="multipart/form-data">
            ...
            <div class="form-row">
              <div  class="form-group col-md-12">
                ...
                <textarea class="form-control" rows="5" name="content_en" id="note" placeholder="Enter Content of post ..."></textarea>
            ...
            <div  class="form-group col-md-12">
                ...
                <textarea class="form-control text-right" rows="5" name="content_ar" id="note" placeholder=" ...ادخل محتوى المنشور"></textarea>
